...
<div class="page-main-style">
	...
	<form action="customBoardWritedlist.do" id="search_form" method="get">
			...
			<article class="board_view">
				<a class="article" href="${pageContext.request.contextPath}/customBoard/customPostDetail.do?post_num=${customPost.post_num}&&board_num=${customPost.board_num}">
					...
					<div style="overflow: hidden;">
						<!-- 프로필 사진 -->	
						<c:if test="${empty member.photoname}">
							<img src="${pageContext.request.contextPath}/resources/images/customBoard/profile0.png" class="picture large">	
						</c:if>
						<!-- 작성자 아이디 -->
						<div class="profile">
