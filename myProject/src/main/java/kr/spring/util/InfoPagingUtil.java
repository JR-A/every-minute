...
public class InfoPagingUtil {
	 ...
	 * */
	public InfoPagingUtil(int currentPage, int totalCount, int rowCount,
	...
	public InfoPagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
			int pageCount,String pageUrl) {
	...
	public InfoPagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
		...
		if (currentPage > pageCount) {
			if(keyword==null){//검색 미사용시
				pagingHtml.append("<a href="+pageUrl+"?infopageNum="+ (startPage - 1) + addKey +">");
			}else{
				pagingHtml.append("<a href="+pageUrl+"?infokeyfield="+keyfield+"&infokeyword="+keyword+"&infopageNum="+ (startPage - 1) + addKey +">");
			}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				if(keyword==null){//검색 미사용시
					pagingHtml.append("&nbsp;<a href='"+pageUrl+"?infopageNum=");
				}else{
					pagingHtml.append("&nbsp;<a href='"+pageUrl+"?infokeyfield="+keyfield+"&infokeyword="+keyword+"&infopageNum=");
				}
				pagingHtml.append(i);
		...
		if (totalPage - startPage >= pageCount) {
			if(keyword==null){//검색 미사용시
				pagingHtml.append("<a href="+pageUrl+"?infopageNum="+ (endPage + 1) + addKey +">");
			}else{
				pagingHtml.append("<a href="+pageUrl+"?infokeyfield="+keyfield+"&infokeyword="+keyword+"&infopageNum="+ (endPage + 1) + addKey +">");
			}
