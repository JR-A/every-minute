...
public class FreePagingUtil {
	 ...
	 * */
	public FreePagingUtil(int currentPage, int totalCount, int rowCount,
	...
	public FreePagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
			int pageCount,String pageUrl) {
	...
	public FreePagingUtil(String keyfield, String keyword, int currentPage, int totalCount, int rowCount,
		...
		if (currentPage > pageCount) {
			if(keyword==null){//검색 미사용시
				pagingHtml.append("<a href="+pageUrl+"?freepageNum="+ (startPage - 1) + addKey +">");
			}else{
				pagingHtml.append("<a href="+pageUrl+"?freekeyfield="+keyfield+"&freekeyword="+keyword+"&freepageNum="+ (startPage - 1) + addKey +">");
			}
		...
		for (int i = startPage; i <= endPage; i++) {
			...
			if (i == currentPage) {
				...
				if(keyword==null){//검색 미사용시
					pagingHtml.append("&nbsp;<a href='"+pageUrl+"?freepageNum=");
				}else{
					pagingHtml.append("&nbsp;<a href='"+pageUrl+"?freekeyfield="+keyfield+"&freekeyword="+keyword+"&freepageNum=");
				}
				pagingHtml.append(i);
		...
		if (totalPage - startPage >= pageCount) {
			if(keyword==null){//검색 미사용시
				pagingHtml.append("<a href="+pageUrl+"?freepageNum="+ (endPage + 1) + addKey +">");
			}else{
				pagingHtml.append("<a href="+pageUrl+"?freekeyfield="+keyfield+"&freekeyword="+keyword+"&freepageNum="+ (endPage + 1) + addKey +">");
			}
