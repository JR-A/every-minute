...
public interface BookStoreMapper {
	...
	@Insert("INSERT INTO bookstoreboard(bs_num,mem_num,bs_selling_price,bs_comment,bs_condition,bs_method,bs_address,uploadfile,filename,isbn) VALUES(bookstore_seq.nextval,#{mem_num},#{bs_selling_price},#{bs_comment},#{bs_condition},#{bs_method},#{bs_address},#{uploadfile},#{filename},#{isbn})")
